...
export function RegularizationScreen({ role }: { role: 'admin' | 'user' | '' }) {
  ...
  return (
    ...
    >
      <Text style={styles.title}>WFH Regularization</Text>
...
const styles = StyleSheet.create({
  ...
  meta: { color: '#9fb0c8', fontSize: 12, marginBottom: 12, lineHeight: 18 },
  form: { marginBottom: 8 },
  section: { color: '#7ee0c5', fontWeight: '700', marginBottom: 8 },
  listHead: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  cardWho: { flex: 1 },
  dateTitle: { color: '#f4f7fb', fontWeight: '800', fontSize: 15 },
  name: { color: '#7ee0c5', fontSize: 12, fontWeight: '700', marginTop: 2 },
  reasonText: { color: '#c5d2e4', fontSize: 13, marginTop: 6 },
  note: { color: '#9fb0c8', fontSize: 12, marginTop: 4, fontStyle: 'italic' },
  pill: { borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4 },
  pillText: { fontSize: 11, fontWeight: '800', color: '#fff', textTransform: 'capitalize' },
